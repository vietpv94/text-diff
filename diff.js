...
diff.prototype.main = function (text1, text2, opt_checklines, opt_deadline) {
  console.log(text1 + "     " + text2); // Set a deadline by which time the diff must be complete.
  ...
  console.log("text2", text2); // Compute the diff on the middle block.

  var diffs = [[DIFF_DELETE, text1], [DIFF_INSERT, text2]];
  console.log("text1", text1);
  console.log("text2", text2);
  console.log(diffs); // Restore the prefix and suffix.
